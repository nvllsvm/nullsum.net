...
BLOG_AUTHOR = "Andrew Rabert"  # (translatable)
BLOG_TITLE = "nullsum"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://nullsum.net/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://nullsum.net/"
BLOG_EMAIL = "ar@nullsum.net"
BLOG_DESCRIPTION = "The thoughts, discoveries, and sounds of Andrew Rabert"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ('/', 'blog'),
#        ('/music', 'music'),
        ('https://github.com/nvllsvm', 'code'),
        ('mailto:' + BLOG_EMAIL, 'contact')
    )
}
...
PAGES = (
    ("pages/about.rst", "", "page.tmpl"),
    ("pages/music.rst", "", "page.tmpl"),
